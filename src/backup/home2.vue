            ...
            <div class='i-main'>
                ...
                <div class='i-maindocter i-maindocter1'>
                    ...
                    <div class="i-maintest">
                        <button  style="border: 1px solid #e2c8a8;height: 28px;color: #e2c8a8;float: right;
                        width: 80px;background-color: #fff;margin-left: 4px;">咨询 299￥</button>
                        <button  @click="tab(0)"  style="border: 1px solid #e2c8a8;height: 28px;color: #e2c8a8;float: right;
                        width: 60px;background-color: #fff;margin-left: 10px;">检测</button>
                    </div>
                    <div class='i-mainportrait'>
                        <img src="../assets/indexheadportrait.png"></div>
                </div>
                <div class='i-maindocter'>
                    <span>胡大夫</span>
                    <div class='i-maintest' @click="tab(1)">
                        <button  style="border: 1px solid #e2c8a8;height: 28px;color: #e2c8a8;float: right;
                        width: 80px;background-color: #fff;margin-left: 4px;">咨询 199￥</button>
                        <button  @click="tab(0)"  style="border: 1px solid #e2c8a8;height: 28px;color: #e2c8a8;float: right;
                        width: 60px;background-color: #fff;margin-left: 10px;">检测</button>
                    </div>
