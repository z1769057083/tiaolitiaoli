<template>
  <div class="picker-slot" :class="classNames" :style="flexStyle">
    <div v-if="!divider" ref="wrapper" class="picker-slot-wrapper" :class="{ dragging: dragging }" style="height:1800px">
...
<script type="text/babel">
  ...
  import { once, addClass, removeClass } from '@/packages/utils/dom';
